...
library("tidyverse", "EcoFoG", "entropart")
```
...
```{r, out.width='60%'}
MyStyle <- list(scale_colour_grey(), theme(legend.position="none"), theme_bw())
P15Map + MyStyle
```
...
```{r, out.width='50%'}
library(entropart)
as.AbdVector(Paracou618.MC$Ns) %>% autoplot(Distribution = "lnorm") + MyStyle
```
